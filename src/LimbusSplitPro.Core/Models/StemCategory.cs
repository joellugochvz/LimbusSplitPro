...
public class StemCategory : INotifyPropertyChanged
{
    ...
    public static List<StemCategory> CreateDefaultCategories()
    {
        return new List<StemCategory>
        {
            ...
            new StemCategory { Id = "vocal_fx",       DisplayName = "Efectos Vocales / Reverb", Description = "Énfasis en altas frecuencias (2–8 kHz) — aire, sibilancia y cola de reverb",            Group = StemGroup.Vocals, IsSelected = false, IsSubStem = true, ParentCategoryKey = "vocals", IconKey = "Waves",         DefaultColorHex = "#D97706" },
